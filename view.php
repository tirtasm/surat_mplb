            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo "<a class='btn btn-warning' href=\"update.php?id=$datanya[id]\">Edit</a>
			<a class='btn btn-danger' href=\"delete.php?id=$datanya[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";?></td>
<!-- <a class='btn btn-warning' href=\"update.php?id=$datanya[id]\">Edit</a>  -->
